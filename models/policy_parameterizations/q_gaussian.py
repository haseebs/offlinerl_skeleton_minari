...
class qMultivariateGaussian(nn.Module):
    ...
    def rsample(self, states, num_samples=1):
        ...
        log_probs = mvbg.log_prob(actions)
    ...
    def log_prob(self, states, actions):
        ...
        with torch.no_grad():
            ...
            given_log_probs = mvbg.log_prob(actions)
            given_log_probs = given_log_probs.view((given_log_probs.shape[0], 1))
        ...
        log_probs = mvbg.log_prob(closest_actions)
        log_probs = log_probs.view((log_probs.shape[0], 1))
